...
const AboutUs = () => {
  return (
    <section className="bg-yellow-50 h-fit lg:pt-0">
      <h3 className="font-merriweatherSans text-red-500 font-bold text-center">
        About Us
      </h3>
      <h1 className="font-anton w-full text-4xl text-center p-4">
        Order delivery in just 30 minutes
      </h1>
      <div className="grid gric1 lg:grid-cols-3 w-4/5 mx-auto gap-5">
        {aboutUs.map(({ id, title, desc, image }) => (
          <div className="w-full bg-white/65 rounded-md shadow-lg p-3" key={id}>

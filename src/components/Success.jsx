  ...
  return (
    <section className="w-full h-[70vh] flex items-center justify-center flex-col">
      <div className="relative flex items-center justify-center w-full h-[80%]">
        ...
        />
        <h1 className="absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] text-9xl -z-10 text-nowrap tracking-widest font-bold font-merriweatherSans text-black/15 text-center">
          Thank You!
        </h1>
      </div>
      ...
      <p className="font-merriweatherSans text-xl text-black/25">
